...
var DayPicker = exports.DayPicker = function (_Component) {
  ...
  function DayPicker(props) {
    ...
    _this.handleContextMenuClick = function (day, modifiers, e) {
      if (_this.props.onContextMenu) {
        _this.props.onContextMenu(day, modifiers, e);
      }
    };
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          onContextMenu: handleEvent(onContextMenu, day, modifiers)
        },
        children
      );
    }
...
var DayPickerInput = function (_React$Component) {
  ...
  _createClass(DayPickerInput, [{
    ...
    value: function handleContextMenuClick(day, modifiers, e) {
      console.warn(day, modifiers, e);
    }
  }, {
    key: 'handleDayClick',
